            ...
            <div id="owl-demo" className="owl-carousel owl-theme">
              <div className="item">
                <div className="w3l-movie-gride-agile w3l-movie-gride-agile1">
                  <a href="single.html" className="hvr-shutter-out-horizontal"><img src="images/m13.jpg" title="album-name" className="img-responsive" alt=" " />
              ...
              <div className="item">
                <div className="w3l-movie-gride-agile w3l-movie-gride-agile1">
                  <a href="single.html" className="hvr-shutter-out-horizontal"><img src="images/m12.jpg" title="album-name" className="img-responsive" alt=" " />
                    <div className="w3l-action-icon"><i className="fa fa-play-circle" aria-hidden="true"></i></div>
                  </a>
                  <div className="mid-1 agileits_w3layouts_mid_1_home">
                    <div className="w3l-movie-text">
